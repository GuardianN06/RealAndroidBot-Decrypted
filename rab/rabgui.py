...
class RABGui(object):
    def __init__(self,config, lang, config_path, device_id=None, gui_lang=None):
        self.version = '1.10.x Development'
        self.win_main = None
        self.config = config
        self.lang = lang
    ...
    def default_disable(self):
        ...
        if self.config['client']['client']  == 'None':
            ...
            messagebox.showinfo(title='Information', message='Please note that all catch will be send to your webhook in this version. More options for farmer will be availible in next version')
    ...
    def enableTelegramFeed_checkbox(self):
        ...
        if self.config['telegram']['enabled']:
            if self.config['telegram']['telegram_api_id'] and self.config['telegram']['telegram_api_hash']:
                ...
                messagebox.showinfo(title='Telegram API ID Needed', message='Please enter Telegram API ID before enable this option')
    ...
    def constructTab2(self):
        ...
        clientChoices = ['None', 'MAD', 'PGSharp', 'PGSharp Paid', 'Pokemod', 'HAL', 'Polygon', 'Polygon Paid', 'Polygon Farmer']
        tab2Frame1Label1 = tk.Label(tempF1ClientOption,text=self.lang[self.gui_lang]['tab2Frame1Label1'].replace('\\n','\n').replace('\\t','\t'))
        #tab2Frame1Label1.grid(row=0, column=0, sticky="E")
        
        tab2Frame1Options = ttk.OptionMenu(tempF1ClientOption, self.clientVar,self.config['client'].get('client','PGSharp'), *clientChoices, command=self.change_dropdown)
        tab2Frame1Label1.pack(side = tk.LEFT)
        tab2Frame1Options.pack(side = tk.LEFT)
        #tab2Frame1Options.grid(row=0, column=1,sticky="EW")
        tab2Frame1Options.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1OptionsMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame1TeamRocket = tk.Checkbutton(tab2Frame1,variable=self.boolTeamRocket,command=self.teamRocket_checkbox,text=self.lang[self.gui_lang]['tab2Frame1TeamRocket'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame1TeamRocket.grid(row=1, column=0,sticky="W")
        self.tab2Frame1TeamRocket.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1TeamRocketMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame1InstantSpin = tk.Checkbutton(tab2Frame1,variable=self.boolInstantSpin,command=self.instantSpin_checkbox,text=self.lang[self.gui_lang]['tab2Frame1InstantSpin'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame1InstantSpin.grid(row=1, column=1,sticky="W")
        self.tab2Frame1InstantSpin.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1InstantSpinMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame1SkipIntro = tk.Checkbutton(tab2Frame1,variable=self.boolSkipIntro,command=self.skipIntro_checkbox,text=self.lang[self.gui_lang]['tab2Frame1SkipIntro'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame1SkipIntro.grid(row=1, column=2,sticky="W")
        self.tab2Frame1SkipIntro.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1SkipIntroMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame1EncounterIV = tk.Checkbutton(tab2Frame1,variable=self.boolEncounterIV,command=self.encounterIV_checkbox,text=self.lang[self.gui_lang]['tab2Frame1EncounterIV'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame1EncounterIV.grid(row=1, column=3,sticky="W")
        self.tab2Frame1EncounterIV.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1EncounterIVMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame1QuickCatch = tk.Checkbutton(tab2Frame1,variable=self.boolQuickCatch,command=self.quickCatch_checkbox,text=self.lang[self.gui_lang]['tab2Frame1QuickCatch'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame1QuickCatch.grid(row=2, column=0,sticky="W")
        self.tab2Frame1QuickCatch.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1QuickCatchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame2AutoRoute = tk.Checkbutton(tab2Frame1,variable=self.boolAutoRoute,command=self.autoRoute_checkbox,text=self.lang[self.gui_lang]['tab2Frame2AutoRoute'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame2AutoRoute.grid(row=2, column=1,sticky="W")
        self.tab2Frame2AutoRoute.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2AutoRouteMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        if self.config['client']['client']  != 'Polygon Paid':
            self.tab2Frame2PokestopPriority = tk.Checkbutton(tab2FrameRAB,variable=self.boolPokestopPriority,command=self.pokestopPriority_checkbox,text=self.lang[self.gui_lang]['tab2Frame2PokestopPriority'].replace('\\n','\n').replace('\\t','\t'))
        else:
            self.tab2Frame2PokestopPriority = tk.Checkbutton(tab2FrameRAB,variable=self.boolPokestopPriority,command=self.pokestopPriority_checkbox,text=self.lang[self.gui_lang]['tab2Frame2PokestopPriority'].replace('\\n','\n').replace('\\t','\t'),state=tk.DISABLED)
        self.tab2Frame2PokestopPriority.grid(row=0, column=0, columnspan=2, sticky="W")
        self.tab2Frame2PokestopPriority.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2PokestopPriorityMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame1AutoGoplus = tk.Checkbutton(tab2FrameRAB,variable=self.boolAutoGoplus,command=self.autoGoplus_checkbox,text=self.lang[self.gui_lang]['tab2Frame1AutoGoplus'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame1AutoGoplus.grid(row=0, column=1,sticky="W")
        tab2Frame1AutoGoplus.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame1AutoGoplusMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        if self.config['client']['client']  != 'Polygon Paid':
            self.tab2Frame2AutoSlotGym = tk.Checkbutton(tab2FrameRAB,variable=self.boolAutoSlotGym,command=self.autoSlotGym_checkbox,text=self.lang[self.gui_lang]['tab2Frame2AutoSlotGym'].replace('\\n','\n').replace('\\t','\t'),state=tk.DISABLED)
        else:
            self.tab2Frame2AutoSlotGym = tk.Checkbutton(tab2FrameRAB,variable=self.boolAutoSlotGym,command=self.autoSlotGym_checkbox,text=self.lang[self.gui_lang]['tab2Frame2AutoSlotGym'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame2AutoSlotGym.grid(row=0, column=2, sticky="W")
        self.tab2Frame2AutoSlotGym.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2AutoSlotGymMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2AdvanceBerryCheck = tk.Checkbutton(tab2FrameRAB,variable=self.boolAdvanceBerryCheck,command=self.advanceBerryCheck_checkbox,text=self.lang[self.gui_lang]['tab2Frame2AdvanceBerryCheck'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2AdvanceBerryCheck.grid(row=0, column=3,sticky="W")
        tab2Frame2AdvanceBerryCheck.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2AdvanceBerryCheckMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2ZoomOutMethod = tk.Label(tempF2ZoomOutMethod,text=self.lang[self.gui_lang]['tab2Frame2ZoomOutMethod'].replace('\\n','\n').replace('\\t','\t'))
        #tab2Frame1Label1.grid(row=0, column=0, sticky="E")
        
        tab2Frame2ZoomOutMethodDropDown = ttk.OptionMenu(tempF2ZoomOutMethod, self.ZoomOutVar,self.config['client'].get('zoom_option','Pinch In'), *ZoomOutMethodChoices, command=self.zoomMethod_dropdown)
        tab2Frame2ZoomOutMethod.pack(side = tk.LEFT)
        tab2Frame2ZoomOutMethodDropDown.pack(side = tk.LEFT)
        #tab2Frame1Options.grid(row=0, column=1,sticky="EW")
        tab2Frame2ZoomOutMethodDropDown.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2ZoomOutMethodMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame2PGSharpShunoHunt = tk.Checkbutton(tab2FrameRAB,variable=self.boolPGSharpShuno,command=self.pgsharpShuno_checkbox,text=self.lang[self.gui_lang]['tab2Frame2PGSharpShunoHunt'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame2PGSharpShunoHunt.grid(row=1, column=2, sticky="W")
        self.tab2Frame2PGSharpShunoHunt.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2PGSharpShunoHuntMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2DisableAutoRestart = tk.Checkbutton(tab2FrameRAB,variable=self.boolDisableAutoRestart,command=self.disableAutoRestart_checkbox,text=self.lang[self.gui_lang]['tab2Frame2DisableAutoRestart'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2DisableAutoRestart.grid(row=1, column=3, sticky="W")
        tab2Frame2DisableAutoRestart.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2DisableAutoRestartMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab2Frame2DisableAutoRestart.bind('<Leave>',self.on_leave)        
        
        # Host IP
        tab2Frame2HostLabel = tk.Label(tab2FrameRAB,text=self.lang[self.gui_lang]['tab2Frame2HostLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab2Frame2Host.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2HostMsg'].replace('\\n','\n').replace('\\t','\t')))
        self.tab2Frame2Host.bind('<Leave>',self.on_leave)
        
        # Port
        tab2Frame2PortLabel = tk.Label(tab2FrameRAB,text=self.lang[self.gui_lang]['tab2Frame2PortLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab2Frame2Port.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2PortMsg'].replace('\\n','\n').replace('\\t','\t')))
        self.tab2Frame2Port.bind('<Leave>',self.on_leave)

        # Timedelay
        tab2Frame2DelayTimeLabel = tk.Label(tab2FrameRAB,text=self.lang[self.gui_lang]['tab2Frame2DelayTimeLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab2Frame2DelayTime.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2DelayTimeMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame2ShinyAutoCatch = tk.Checkbutton(tab2FrameRAB,variable=self.boolShinyHuntAutoCatch,command=self.shinyHuntAutoCatch_checkbox,text='Shiny Hunt ' + self.lang[self.gui_lang]['tab5Frame2ShinyAutoCatch'].replace('\\n','\n').replace('\\t','\t'))
        self.tab2Frame2ShinyAutoCatch.grid(row=2, column=3,sticky="W")
        self.tab2Frame2ShinyAutoCatch.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame2ShinyAutoCatchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab2Frame2PGSharpReposition = tk.Checkbutton(tab2FrameRAB,variable=self.boolPGSharpReposition,command=self.pgsharpReposition_checkbox,text='PGSharp Reposition')
        self.tab2Frame2PGSharpReposition.grid(row=3, column=3, sticky="W")
        self.tab2Frame2PGSharpReposition.bind('<Enter>', lambda event: self.on_enter(event, msg='RAB will auto shift PGSharp icons if this is enabled. Disable it to manually shift it yourself'))    
        ...
        tab2Frame2ManualResolution = tk.Checkbutton(tab2Frame2,variable=self.boolManualResolution,command=self.manualResolution_checkbox,text=self.lang[self.gui_lang]['tab2Frame2ManualResolution'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2ManualResolution.grid(row=0, column=0,sticky="W")
        tab2Frame2ManualResolution.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2ManualResolutionMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2AutoOffset = tk.Checkbutton(tab2Frame2,variable=self.boolAutoOffset,command=self.autoOffset_checkbox,text=self.lang[self.gui_lang]['tab2Frame2AutoOffset'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2AutoOffset.grid(row=0, column=1,sticky="W")
        tab2Frame2AutoOffset.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2AutoOffsetMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2ScreenOffset = tk.Scale(tab2Frame2, orient=tk.HORIZONTAL, variable=self.intScreenOffset, from_=0, to=200, length=150, command=self.screenOffset_scale, label=self.lang[self.gui_lang]['tab2Frame2ScreenOffset'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2ScreenOffset.grid(row=1, column=0,sticky="W")
        tab2Frame2ScreenOffset.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2ScreenOffsetMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2NavigationOffset = tk.Scale(tab2Frame2, orient=tk.HORIZONTAL, variable=self.intNavigationOffset, from_=0, to=200, length=150, command=self.navigationOffset_scale, label=self.lang[self.gui_lang]['tab2Frame2NavigationOffset'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2NavigationOffset.grid(row=1, column=1,sticky="W")
        tab2Frame2NavigationOffset.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2NavigationOffsetMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2ScreenshotOffset = tk.Scale(tab2Frame2, orient=tk.HORIZONTAL, variable=self.intScreenshotOffset, from_=0, to=200, length=150, command=self.screenshotOffset_scale, label=self.lang[self.gui_lang]['tab2Frame2ScreenshotOffset'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2ScreenshotOffset.grid(row=1, column=2,sticky="W")
        tab2Frame2ScreenshotOffset.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2ScreenshotOffsetMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2LowerResolution = tk.Checkbutton(tab2Frame2,variable=self.boolLowerResolution,command=self.lowerResolution_checkbox,text=self.lang[self.gui_lang]['tab2Frame2LowerResolution'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2LowerResolution.grid(row=0, column=2,sticky="W")
        tab2Frame2LowerResolution.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2LowerResolutionMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab2Frame2LowerResolution.bind('<Leave>',self.on_leave)
        
        # Density
        tab2Frame2DensityLabel = tk.Label(tab2Frame2,text=self.lang[self.gui_lang]['tab2Frame2Density'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab2Frame2Density.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2DensityMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame2DimPhone = tk.Checkbutton(tab2Frame2,variable=self.boolDimPhone,command=self.dimPhone_checkbox,text=self.lang[self.gui_lang]['tab2Frame2DimPhone'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame2DimPhone.grid(row=2, column=0,sticky="W")
        tab2Frame2DimPhone.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame2DimPhoneMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordEnabled = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordEnabled,command=self.discordEnabled_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordEnabled'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordEnabled.grid(row=0, column=0,sticky="W")
        tab2Frame3DiscordEnabled.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordEnabledMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3WebhookLabel = tk.Label(tempWebhook,text=self.lang[self.gui_lang]['tab2Frame3WebhookLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab2Frame3WebhookAddress.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3WebhookAddressMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordAll = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordAll,command=self.manualDiscordAll_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordAll'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordAll.grid(row=1, column=0,sticky="W")
        tab2Frame3DiscordAll.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordAllMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordAllEncountered = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordAllEncountered,command=self.manualDiscordAllEncountered_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordAllEncountered'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordAllEncountered.grid(row=1, column=1,sticky="W")
        tab2Frame3DiscordAllEncountered.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordAllEncounteredMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordEncountered = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordEncountered,command=self.manualDiscordEncountered_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordEncountered'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordEncountered.grid(row=1, column=2,sticky="W")
        tab2Frame3DiscordEncountered.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordEncounteredMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordCaughtOrFled = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordCaughtOrFled,command=self.manualDiscordCaughtOrFled_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordCaughtOrFled'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordCaughtOrFled.grid(row=1, column=3,sticky="W")
        tab2Frame3DiscordCaughtOrFled.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordCaughtOrFledMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordShiny = tk.Checkbutton(tab2Frame3,variable=self.boolDiscordShiny,command=self.manualDiscordShiny_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordShiny'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordShiny.grid(row=2, column=0,sticky="W")
        tab2Frame3DiscordShiny.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordShinyMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3Discord100IV= tk.Checkbutton(tab2Frame3,variable=self.boolDiscord100IV,command=self.manualDiscord100IV_checkbox,text=self.lang[self.gui_lang]['tab2Frame3Discord100IV'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3Discord100IV.grid(row=2, column=1,sticky="W")
        tab2Frame3Discord100IV.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3Discord100IVMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame3DiscordPVPIV= tk.Checkbutton(tab2Frame3,variable=self.boolDiscordPVP,command=self.manualDiscordPVP_checkbox,text=self.lang[self.gui_lang]['tab2Frame3DiscordPVPIV'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame3DiscordPVPIV.grid(row=2, column=2,sticky="W")
        tab2Frame3DiscordPVPIV.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame3DiscordPVPIVMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame4QuestEnabled = tk.Checkbutton(tab2Frame4,variable=self.boolQuestEnabled,command=self.questEnabled_checkbox,text=self.lang[self.gui_lang]['tab2Frame4QuestEnabled'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame4QuestEnabled.grid(row=0, column=0,sticky="W")
        tab2Frame4QuestEnabled.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame4QuestEnabledMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame4PowerUpScale = tk.Scale(tab2Frame4, orient=tk.HORIZONTAL, variable=self.intPowerUp, from_=0, to=50, length=150, command=self.powerUp_scale, label=self.lang[self.gui_lang]['tab2Frame4PowerUpScale'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame4PowerUpScale.grid(row=1, column=0,sticky="W")
        tab2Frame4PowerUpScale.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame4PowerUpScaleMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2Frame4ClearQuestScale = tk.Scale(tab2Frame4, orient=tk.HORIZONTAL, variable=self.intClearQuest, from_=0, to=120, length=150, command=self.clearQuest_scale, label=self.lang[self.gui_lang]['tab2Frame4ClearQuestScale'].replace('\\n','\n').replace('\\t','\t'))
        tab2Frame4ClearQuestScale.grid(row=1, column=1,sticky="W")
        tab2Frame4ClearQuestScale.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2Frame4ClearQuestScaleMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2QuestTodayEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2QuestTodayEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab2QuestSpecialEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab2QuestSpecialEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
    ...
    def constructTab3(self):
        ...
        tab3Frame1KeepMon = tk.Checkbutton(tab3Frame1,variable=self.boolKeepMon,command=self.keepMon_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepMon'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepMon.grid(row=0, column=0,sticky="W")
        tab3Frame1KeepMon.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepMonMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame1KeepMon.bind('<Leave>',self.on_leave)
        
        self.boolUseOr = IntVar()
        self.boolUseOr.set(self.config['catch'].get('or_condition',0))
        tab3Frame1OrCondition =  tk.Checkbutton(tab3Frame1,variable=self.boolUseOr,command=self.useOr_checkbox,text=self.lang[self.gui_lang]['tab3Frame1OrCondition'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1OrCondition.grid(row=0, column=3,sticky="W")
        tab3Frame1OrCondition.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1OrConditionMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame1OrCondition.bind('<Leave>',self.on_leave)
        
        # On Screen Offset 
        self.intMinAtk = IntVar()
        self.intMinAtk.set(self.config['catch'].get('min_atk',15))
        tab3Frame1MinAtk = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intMinAtk, from_=0, to=15, length=150, command=self.minAtk_scale, label=self.lang[self.gui_lang]['tab3Frame1MinAtk'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1MinAtk.grid(row=1, column=0,sticky="W")
        tab3Frame1MinAtk.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1MinAtkMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame1MinAtk.bind('<Leave>',self.on_leave)
        
        self.intMinDef = IntVar()
        self.intMinDef.set(self.config['catch'].get('min_def',15))
        tab3Frame1MinDef = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intMinDef, from_=0, to=15, length=150, command=self.minDef_scale, label=self.lang[self.gui_lang]['tab3Frame1MinDef'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1MinDef.grid(row=1, column=1,sticky="W")
        tab3Frame1MinDef.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1MinDefMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame1MinDef.bind('<Leave>',self.on_leave)
        
        self.intMinSta = IntVar()
        self.intMinSta.set(self.config['catch'].get('min_sta',15))
        tab3Frame1MinSta = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intMinSta, from_=0, to=15, length=150, command=self.minSta_scale, label=self.lang[self.gui_lang]['tab3Frame1MinSta'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1MinSta.grid(row=1, column=2,sticky="W")
        tab3Frame1MinSta.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1MinStaMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame1MinSta.bind('<Leave>',self.on_leave)
        
        self.intMinLvl = IntVar()
        self.intMinLvl.set(self.config['catch'].get('min_lvl',1))
        tab3Frame1MinLvl = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intMinLvl, from_=0, to=35, length=150, command=self.minLvl_scale, label=self.lang[self.gui_lang]['tab3Frame1MinLvl'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1MinLvl.grid(row=1, column=3,sticky="W")
        tab3Frame1MinLvl.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1MinLvlMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1KeepShiny = tk.Checkbutton(tab3Frame1,variable=self.boolKeepShiny,command=self.keepShiny_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepShiny'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepShiny.grid(row=2, column=0,sticky="W")
        tab3Frame1KeepShiny.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepShinyMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1KeepStrongShadow= tk.Checkbutton(tab3Frame1,variable=self.boolKeepStrongShadow,command=self.keepStrongShadow_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepStrongShadow'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepStrongShadow.grid(row=2, column=1,sticky="W")
        tab3Frame1KeepStrongShadow.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepStrongShadowMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1KeepLegendary= tk.Checkbutton(tab3Frame1,variable=self.boolKeepLegendary,command=self.keepLegendary_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepLegendary'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepLegendary.grid(row=2, column=2, sticky="W")
        tab3Frame1KeepLegendary.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepLegendaryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1KeepLucky= tk.Checkbutton(tab3Frame1,variable=self.boolKeepLucky,command=self.keepLucky_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepLucky'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepLucky.grid(row=2, column=3,sticky="W")
        tab3Frame1KeepLucky.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepLuckyMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1KeepEvent= tk.Checkbutton(tab3Frame1,variable=self.boolKeepEvent,command=self.keepEvent_checkbox,text=self.lang[self.gui_lang]['tab3Frame1KeepEvent'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1KeepEvent.grid(row=3, column=0,sticky="W")
        tab3Frame1KeepEvent.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1KeepEventMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1ShinyTap= tk.Checkbutton(tab3Frame1,variable=self.boolShinyTap,command=self.shinyTap_checkbox,text=self.lang[self.gui_lang]['tab3Frame1ShinyTap'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1ShinyTap.grid(row=4, column=0,sticky="W")
        tab3Frame1ShinyTap.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1ShinyTapMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1AppraisalDelay = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.dblAppraisalDelay, from_=0.0, to=5.0, resolution=0.1, length=150, command=self.appraisalDelay_scale, label=self.lang[self.gui_lang]['tab3Frame1AppraisalDelay'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame1AppraisalDelay.grid(row=4, column=1,sticky="W")
        tab3Frame1AppraisalDelay.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1AppraisalDelay'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1HighFarPokemonLabel = tk.Label(tab3Frame1,text=self.lang[self.gui_lang]['tab3Frame1HighFarPokemonLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtHighFarPokemon.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtHighFarPokemonMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1Mon2Keep = tk.Label(tab3Frame1,text=self.lang[self.gui_lang]['tab3Frame1Mon2Keep'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtMon2Keep.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtMon2KeepMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1Shadow2Keep = tk.Label(tab3Frame1,text=self.lang[self.gui_lang]['tab3Frame1Shadow2Keep'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtShadow2Keep.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtShadow2KeepMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame1Poke2Chase = tk.Label(tab3Frame1,text=self.lang[self.gui_lang]['tab3Frame1Poke2Chase'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtPoke2Chase.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1Poke2ChaseMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1StopAtBall = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intStopAtBall, from_=0, to=100, resolution=5, length=150, command=self.stopAtBall_scale, label=self.lang[self.gui_lang]['tab3Frame1StopAtBall'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1StopAtBall.grid(row=9, column=0,sticky="W")
        self.tab3Frame1StopAtBall.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1StopAtBallMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1ResumeAtBall = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intResumeAtBall, from_=0, to=300, resolution=10, length=150, command=self.resumeAtBall_scale, label=self.lang[self.gui_lang]['tab3Frame1ResumeAtBall'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1ResumeAtBall.grid(row=9, column=1,sticky="W")
        self.tab3Frame1ResumeAtBall.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1ResumeAtBallMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1CatchEveryXSpin = tk.Scale(tab3Frame1, orient=tk.HORIZONTAL, variable=self.intCatchEveryXSpin , from_=0, to=20, resolution=1, length=150, command=self.catchEveryXSpin_scale, label=self.lang[self.gui_lang]['tab3Frame1CatchEveryXSpin'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1CatchEveryXSpin.grid(row=9, column=2,sticky="W")
        self.tab3Frame1CatchEveryXSpin.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1CatchEveryXSpinMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1GoAfterShiny= tk.Checkbutton(tab3Frame1,variable=self.boolGoAfterShiny,command=self.goAfterShiny_checkbox,text=self.lang[self.gui_lang]['tab3Frame1GoAfterShiny'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1GoAfterShiny.grid(row=10, column=0,sticky="W")
        self.tab3Frame1GoAfterShiny.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1GoAfterShinyMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1GoAfterMaxIV= tk.Checkbutton(tab3Frame1,variable=self.boolGoAfterMaxIV,command=self.goAfterMaxIV_checkbox,text=self.lang[self.gui_lang]['tab3Frame1GoAfterMaxIV'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1GoAfterMaxIV.grid(row=10, column=1,sticky="W")
        self.tab3Frame1GoAfterMaxIV.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1GoAfterMaxIVMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab3Frame1ShinyMode= tk.Checkbutton(tab3Frame1,variable=self.boolShinyMode,command=self.shinyMode_checkbox,text=self.lang[self.gui_lang]['tab3Frame1ShinyMode'].replace('\\n','\n').replace('\\t','\t'), state=state)
        self.tab3Frame1ShinyMode.grid(row=10, column=2,sticky="W")
        self.tab3Frame1ShinyMode.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame1ShinyModeMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame2UseBerry = tk.Checkbutton(tab3Frame2,variable=self.boolUseBerry,command=self.useBerry_checkbox,text=self.lang[self.gui_lang]['tab3Frame2UseBerry'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame2UseBerry.grid(row=0, column=0,sticky="W")
        tab3Frame2UseBerry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame2UseBerryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame2BerryP1 = tk.Label(tempBerryP1,text=self.lang[self.gui_lang]['tab3Frame2BerryP1'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtBerryP1.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtBerryP1'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame2BerryP2 = tk.Label(tempBerryP2,text=self.lang[self.gui_lang]['tab3Frame2BerryP2'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtBerryP2.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtBerryP2'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame2BerryP3 = tk.Label(tempBerryP3,text=self.lang[self.gui_lang]['tab3Frame2BerryP3'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtBerryP3.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtBerryP3'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame2PinapExclusive = tk.Label(tempBerryPinapExclusive,text=self.lang[self.gui_lang]['tab3Frame2PinapExclusive'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtPinapExclusive.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtPinapExclusive'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame3SelectBall = tk.Checkbutton(tab3Frame3,variable=self.boolSelectBall,command=self.selectBall_checkbox,text=self.lang[self.gui_lang]['tab3Frame3SelectBall'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame3SelectBall.grid(row=0, column=0,sticky="W")
        tab3Frame3SelectBall.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame3SelectBallMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame3SelectBallP1 = tk.Label(tempSelectBallP1,text=self.lang[self.gui_lang]['tab3Frame3SelectBallP1'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtSelectBallP1.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtSelectBallP1'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame3SelectBallP2 = tk.Label(tempSelectBallP2,text=self.lang[self.gui_lang]['tab3Frame3SelectBallP2'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtSelectBallP2.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtSelectBallP2'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame3SelectBallP3 = tk.Label(tempSelectBallP3,text=self.lang[self.gui_lang]['tab3Frame3SelectBallP3'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtSelectBallP3.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtSelectBallP3'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame4EnablePVP = tk.Checkbutton(tab3Frame4,variable=self.boolEnablePVP,command=self.enablePVP_checkbox,text=self.lang[self.gui_lang]['tab3Frame4EnablePVP'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame4EnablePVP.grid(row=0, column=0,sticky="W")
        tab3Frame4EnablePVP.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame4EnablePVPMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame4GL2Keep = tk.Label(tempGL2Keep,text=self.lang[self.gui_lang]['tab3Frame4GL2Keep'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtGL2Keep.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtGL2Keep'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame4GLRating = tk.Scale(tab3Frame4, orient=tk.HORIZONTAL, variable=self.dblGLRating, from_=88.0, to=100.0, resolution=0.1, length=150, command=self.glRating_scale, label=self.lang[self.gui_lang]['tab3Frame4GLRating'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame4GLRating.grid(row=1, column=2,sticky="W")
        tab3Frame4GLRating.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame4GLRatingMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame4GLRating.bind('<Leave>',self.on_leave)
        
        self.intGLCP = IntVar()
        self.intGLCP.set(self.config['pvp'].get('gl_cp',1400))
        tab3Frame4GLCP = tk.Scale(tab3Frame4, orient=tk.HORIZONTAL, variable=self.intGLCP, from_=1000, to=1500, resolution=10, length=150, command=self.glCP_scale, label=self.lang[self.gui_lang]['tab3Frame4GLCP'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame4GLCP.grid(row=1, column=3,sticky="W")
        tab3Frame4GLCP.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame4GLCPMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame4UL2Keep = tk.Label(tempUL2Keep,text=self.lang[self.gui_lang]['tab3Frame4UL2Keep'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtUL2Keep.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['txtUL2Keep'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab3Frame4ULRating = tk.Scale(tab3Frame4, orient=tk.HORIZONTAL, variable=self.dblULRating, from_=88.0, to=100.0, resolution=0.1, length=150, command=self.ulRating_scale, label=self.lang[self.gui_lang]['tab3Frame4ULRating'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame4ULRating.grid(row=2, column=2,sticky="W")
        tab3Frame4ULRating.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame4ULRatingMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab3Frame4ULRating.bind('<Leave>',self.on_leave)
        
        self.intULCP = IntVar()
        self.intULCP.set(self.config['pvp'].get('ul_cp',1400))
        tab3Frame4ULCP = tk.Scale(tab3Frame4, orient=tk.HORIZONTAL, variable=self.intULCP, from_=2000, to=2500, resolution=10, length=150, command=self.ulCP_scale, label=self.lang[self.gui_lang]['tab3Frame4ULCP'].replace('\\n','\n').replace('\\t','\t'))
        tab3Frame4ULCP.grid(row=2, column=3,sticky="W")
        tab3Frame4ULCP.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab3Frame4ULCPMsg'].replace('\\n','\n').replace('\\t','\t')))
    ...
    def constructTab4(self):
        ...
        tab4Frame1EnablePokeManagement = tk.Checkbutton(tab4Frame1,variable=self.boolEnablePokeManagement,command=self.enablePokeManagement_checkbox,text=self.lang[self.gui_lang]['tab4Frame1EnablePokeManagement'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame1EnablePokeManagement.grid(row=0, column=0,sticky="W")
        tab4Frame1EnablePokeManagement.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1EnablePokeManagementMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame1ManageOnStart = tk.Checkbutton(tab4Frame1,variable=self.boolManageOnStart,command=self.manageOnStart_checkbox,text=self.lang[self.gui_lang]['tab4Frame1ManageOnStart'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame1ManageOnStart.grid(row=0, column=1,sticky="W")
        tab4Frame1ManageOnStart.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1ManageOnStartMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab4Frame1InventoryIV = tk.Checkbutton(tab4Frame1,variable=self.boolInventoryIV,command=self.inventoryIV_checkbox,text=self.lang[self.gui_lang]['tab4Frame1InventoryIV'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab4Frame1InventoryIV.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1InventoryIVMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame1StopCheck = tk.Scale(tab4Frame1, orient=tk.HORIZONTAL, variable=self.intStopCheck, from_=0, to=300, resolution=10, length=150, command=self.stopCheck_scale, label=self.lang[self.gui_lang]['tab4Frame1StopCheck'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame1StopCheck.grid(row=0, column=3,sticky="W")
        tab4Frame1StopCheck.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1StopCheckMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame1MassTransfer = tk.Checkbutton(tab4Frame1,variable=self.boolMassTransfer,command=self.massTransfer_checkbox,text=self.lang[self.gui_lang]['tab4Frame1MassTransfer'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame1MassTransfer.grid(row=1, column=0,sticky="W")
        tab4Frame1MassTransfer.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1MassTransferMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab4Frame1MassTransfer.bind('<Leave>',self.on_leave)
        
        # Search String
        tab4Frame1PokeBagSearchLabel = tk.Label(tab4Frame1,text=self.lang[self.gui_lang]['tab4Frame1PokeBagSearchLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab4Frame1PokeBagSearchEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame1PokeBagSearchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame2EnableItemManagement = tk.Checkbutton(tab4Frame2,variable=self.boolEnableItemManagement,command=self.enableItemManagement_checkbox,text=self.lang[self.gui_lang]['tab4Frame2EnableItemManagement'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame2EnableItemManagement.grid(row=0, column=0,sticky="W")
        tab4Frame2EnableItemManagement.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2EnableItemManagementMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame2ClearItemOnStart = tk.Checkbutton(tab4Frame2,variable=self.boolClearItemOnStart,command=self.clearItemOnStart_checkbox,text=self.lang[self.gui_lang]['tab4Frame2ClearItemOnStart'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame2ClearItemOnStart.grid(row=0, column=1,sticky="W")
        tab4Frame2ClearItemOnStart.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2ClearItemOnStartMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        self.tab4Frame2AutoMax = tk.Checkbutton(tab4Frame2,variable=self.boolAutoMax,command=self.autoMax_checkbox,text=self.lang[self.gui_lang]['tab4Frame2AutoMax'].replace('\\n','\n').replace('\\t','\t'))
        if self.config['client'].get('client','None').lower() not in ['HAL']:
            self.tab4Frame2AutoMax.config(state=tk.DISABLED)
        self.tab4Frame2AutoMax.grid(row=0, column=2,sticky="W")
        self.tab4Frame2AutoMax.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2AutoMaxMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame2ItemInterval = tk.Scale(tab4Frame2, orient=tk.HORIZONTAL, variable=self.intItemInterval, from_=0, to=120, resolution=10, length=150, command=self.itemInterval_scale, label=self.lang[self.gui_lang]['tab4Frame2ItemInterval'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame2ItemInterval.grid(row=1, column=0,sticky="W")
        tab4Frame2ItemInterval.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2ItemIntervalMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab4Frame2BallFullInterval = tk.Scale(tab4Frame2, orient=tk.HORIZONTAL, variable=self.intBagFullInterval, from_=0, to=120, resolution=10, length=150, command=self.bagFullInterval_scale, label=self.lang[self.gui_lang]['tab4Frame2BallFullInterval'].replace('\\n','\n').replace('\\t','\t'))
        tab4Frame2BallFullInterval.grid(row=1, column=1,sticky="W")
        tab4Frame2BallFullInterval.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2BallFullIntervalMsg'].replace('\\n','\n').replace('\\t','\t')))
        tab4Frame2BallFullInterval.bind('<Leave>',self.on_leave)
        
        tab4Frame2Item2QuitLabel = tk.Label(tab4Frame2,text=self.lang[self.gui_lang]['tab4Frame2Item2QuitLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab4Frame2Item2QuitEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab4Frame2Item2QuitEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        for key, value in all_items.items():
            ...
            self.itemEntries[i].bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['itemCheckbox'].replace('\\n','\n').replace('\\t','\t')))
    ...
    def constructTab5(self):
        ...
        tab5Frame1EnableTelegramFeed = tk.Checkbutton(tab5Frame1,variable=self.boolEnableTelegramFeed,command=self.enableTelegramFeed_checkbox,text=self.lang[self.gui_lang]['tab5Frame1EnableTelegramFeed'].replace('\\n','\n').replace('\\t','\t'))
        tab5Frame1EnableTelegramFeed.grid(row=0, column=0,sticky="W")
        tab5Frame1EnableTelegramFeed.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame1EnableTelegramFeedMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame1TelegramApiIDLabel = tk.Label(tab5Frame1TmpFrame1,text=self.lang[self.gui_lang]['tab5Frame1TelegramApiIDLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame1TelegramApiIDEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame1TelegramApiIDEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame1TelegramApiHashLabel = tk.Label(tab5Frame1TmpFrame2,text=self.lang[self.gui_lang]['tab5Frame1TelegramApiHashLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame1TelegramApiHashEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame1TelegramApiHashEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame1TelegramProxyLabel = tk.Label(tab5Frame1TmpFrame3,text=self.lang[self.gui_lang]['tab5Frame1TelegramProxyLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame1TelegramProxyEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame1TelegramProxyEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame2EnableShinyCheck = tk.Checkbutton(self.tab5Frame2,variable=self.boolEnableShinyCheck,command=self.enableShinyCheck_checkbox,text=self.lang[self.gui_lang]['tab5Frame2EnableShinyCheck'].replace('\\n','\n').replace('\\t','\t'))
        tab5Frame2EnableShinyCheck.grid(row=0, column=0,sticky="W")
        tab5Frame2EnableShinyCheck.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame2EnableShinyCheckMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame2ShinyAutoCatch = tk.Checkbutton(self.tab5Frame2,variable=self.boolShinyAutoCatch,command=self.shinyAutoCatch_checkbox,text=self.lang[self.gui_lang]['tab5Frame2ShinyAutoCatch'].replace('\\n','\n').replace('\\t','\t'))
        tab5Frame2ShinyAutoCatch.grid(row=0, column=1,sticky="W")
        tab5Frame2ShinyAutoCatch.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame2ShinyAutoCatchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame2FeedFree = tk.Checkbutton(tab5Frame2FeedOption,variable=self.boolFeedFree,command=self.feedFree_checkbox,text=self.lang[self.gui_lang]['tab5Frame2FeedFree'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame2Feed100IVShiny = tk.Checkbutton(tab5Frame2FeedOption,variable=self.boolFeed100IVShiny,command=self.feed100IVShiny_checkbox,text=self.lang[self.gui_lang]['tab5Frame2Feed100IVShiny'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame2Feed82IVShiny = tk.Checkbutton(tab5Frame2FeedOption,variable=self.boolFeed82IVShiny,command=self.feed82IVShiny_checkbox,text=self.lang[self.gui_lang]['tab5Frame2Feed82IVShiny'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame2PVPShiny = tk.Checkbutton(tab5Frame2FeedOption,variable=self.boolFeedPVP,command=self.feedPVP_checkbox,text='PVP')
        ...
        self.tab5Frame2FeedRare100IV = tk.Checkbutton(tab5Frame2FeedOption,variable=self.boolFeedRare100IV,command=self.feedRare100IV_checkbox,text=self.lang[self.gui_lang]['tab5Frame2FeedRare100IV'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame2ShinyMon2Catch = tk.Label(self.tab5Frame2,text=self.lang[self.gui_lang]['tab5Frame2ShinyMon2Catch'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtShinyMon2Catch.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame2ShinyMon2CatchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame2ShinyMon2Ignore = tk.Label(self.tab5Frame2,text=self.lang[self.gui_lang]['tab5Frame2ShinyMon2Ignore'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.txtShinyMon2Ignore.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame2ShinyMon2IgnoreMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3EnableSnipeCheck = tk.Checkbutton(self.tab5Frame3,variable=self.boolEnableSnipeCheck,command=self.enableSnipeCheck_checkbox,text=self.lang[self.gui_lang]['tab5Frame3EnableSnipeCheck'].replace('\\n','\n').replace('\\t','\t'))
        tab5Frame3EnableSnipeCheck.grid(row=0, column=0,sticky="W")
        tab5Frame3EnableSnipeCheck.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3EnableSnipeCheckMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3SnipeAutoCatch = tk.Checkbutton(self.tab5Frame3,variable=self.boolSnipeAutoCatch,command=self.snipeAutoCatch_checkbox,text=self.lang[self.gui_lang]['tab5Frame3SnipeAutoCatch'].replace('\\n','\n').replace('\\t','\t'))
        tab5Frame3SnipeAutoCatch.grid(row=0, column=1,sticky="W")
        tab5Frame3SnipeAutoCatch.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3SnipeAutoCatchMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3SnipeMaxCDLabel = tk.Label(tab5Frame3TmpFrame1,text=self.lang[self.gui_lang]['tab5Frame3SnipeMaxCDLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame3SnipeMaxCDEntry.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3SnipeMaxCDEntryMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3FeedFree = tk.Checkbutton(tab5Frame3FeedOption,variable=self.boolSnipeFeedFree,command=self.feedSnipeFree_checkbox,text=self.lang[self.gui_lang]['tab5Frame3FeedSnipeFree'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame3Feed100IVShiny = tk.Checkbutton(tab5Frame3FeedOption,variable=self.boolSnipeFeed100IVShiny,command=self.feedSnipe100IV_checkbox,text=self.lang[self.gui_lang]['tab5Frame3FeedSnipe100IVShiny'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame3Feed82IVShiny = tk.Checkbutton(tab5Frame3FeedOption,variable=self.boolSnipeFeed82IVShiny,command=self.feedSnipe82IV_checkbox,text=self.lang[self.gui_lang]['tab5Frame3FeedSnipe82IVShiny'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame3PVP = tk.Checkbutton(tab5Frame3FeedOption,variable=self.boolSnipeFeedPVP,command=self.feedSnipePVP_checkbox,text='PVP')
        ...
        self.tab5Frame3FeedRare100IV = tk.Checkbutton(tab5Frame3FeedOption,variable=self.boolSnipeFeedRare100IV,command=self.feedSnipeRare100IV_checkbox,text=self.lang[self.gui_lang]['tab5Frame3FeedSnipeRare100IV'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame3SnipeListLabel = tk.Label(self.tab5Frame3,text=self.lang[self.gui_lang]['tab5Frame3SnipeListLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame3SnipeList.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3SnipeListMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3SnipeRouteNameLabel = tk.Label(tab5Frame3TmpFrame2,text=self.lang[self.gui_lang]['tab5Frame3SnipeRouteNameLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        tab5Frame3SnipeRouteName.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3SnipeRouteNameMsg'].replace('\\n','\n').replace('\\t','\t')))
        ...
        tab5Frame3SnipeCoordinatesLabel = tk.Label(tab5Frame3TmpFrame3,text=self.lang[self.gui_lang]['tab5Frame3SnipeCoordinatesLabel'].replace('\\n','\n').replace('\\t','\t'))
        ...
        self.tab5Frame3SnipeCoordinates.bind('<Enter>', lambda event: self.on_enter(event, msg=self.lang[self.gui_lang]['tab5Frame3SnipeCoordinatesMsg'].replace('\\n','\n').replace('\\t','\t')))
    ...
    def start_win(self, parent):
        ...
        self.tabControl.add(self.ContainerThree, text=self.lang[self.gui_lang]['tab3'].replace('\\n','\n').replace('\\t','\t'))
        ...
        if self.win_main.winfo_screenwidth() < 1920 or self.win_main.winfo_screenheight() < 1080:
            logger.warning(self.lang[self.gui_lang]['screenSizeWarning'].replace('\\n','\n').replace('\\t','\t') + '{} x {}'.format(self.win_main.winfo_screenwidth(),self.win_main.winfo_screenheight()))
